 <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ticket.aspx.cs" Inherits="presentationWeb.Ticket" %>
...
<body>
    ...
    <asp:LinkButton class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" runat="server" id="lbtnFilters" OnClick="lbtnFilters_Click"><i class="fas fa-filter fa-sm text-white-50"></i> Filter</asp:LinkButton>
    </div>

    <div id="divFilters" class="mytickets shadow" runat="server" visible="false">
    <div class="card-header" ><i class="fas fa-filter fa-sm"></i> Filters<asp:LinkButton ID="lbtnCloseFilter" runat="server" OnClick="lbtnCloseFilter_Click"><i class="fas fa-times float-right"></i></asp:LinkButton></div>
    <div class="text-left" style="margin: 1rem;">
    Name: <asp:TextBox id="txtNameFilter" runat="server"></asp:TextBox><asp:LinkButton runat="server" ID="lbtnNameFilter" OnClick="lbtnNameFilter_Click"><i class="fas fa-filter" style="margin: 0.5rem;"></i></asp:LinkButton>
    <br />
    Subject: <asp:DropDownList ID="ddlSubjectFilter" runat="server"></asp:DropDownList><asp:LinkButton runat="server" ID="lbtnSubjectFilter" OnClick="lbtnSubjectFilter_Click"><i class="fas fa-filter" style="margin: 0.5rem;"></i></asp:LinkButton>
    </div>
    </div>

    <div class="contentsection">
    <div class="tickets shadow">
    <div class="card-header"><i class="fas fa-ticket-alt"></i> Tickets<a  ID="btnAddmain" data-toggle="modal" data-target="#insertModal" style="cursor: pointer;color:#68bd73; float: right;">Add <i class="fas fa-plus-square"></i></a></div>

    <asp:GridView onselectedindexchanged="gvVraag_selected" ID="gvVraag" runat="server" CssClass="table table-condensed table-hover" Width="100%" OnRowDeleting="OnRowDeleteVraag" OnRowUpdating="OnRowUpdatingVraag" OnRowEditing="OnRowEditingVraag" OnRowCancelingEdit="OnRowCancelingEditVraag" AutoGenerateColumns="False" DataKeyNames="ticket_id" AutoGenerateDeleteButton="False" AutoGenerateEditButton="False" AllowPaging="true" PageSize="5" onpageindexchanging="gvVraag_PageIndexChanging">
    <Columns>

    <asp:TemplateField AccessibleHeaderText="Edit"  ShowHeader="False">
    <ItemTemplate>
    <asp:LinkButton ID="lnkbtnEdit" runat="server" CausesValidation="False" CommandName="Edit"><i class="far fa-edit"></i></asp:LinkButton>
    </ItemTemplate> 
    </asp:TemplateField>

    <asp:TemplateField AccessibleHeaderText="Delete"  ShowHeader="False">
    <ItemTemplate>
    <asp:LinkButton ID="lnkbtnDelete" runat="server" CausesValidation="False" CommandName="Delete"><i class="far fa-trash-alt"></i></asp:LinkButton>
    </ItemTemplate>
    </asp:TemplateField>
    
    <asp:TemplateField AccessibleHeaderText="Update"  ShowHeader="False" Visible="false">
    <ItemTemplate>
    <asp:LinkButton ID="lnkbtnUpdate"   runat="server" CausesValidation="False" CommandName="Update"><i class="far fa-check-circle"></i></asp:LinkButton>
    </ItemTemplate>
    </asp:TemplateField>

    <asp:TemplateField AccessibleHeaderText="Cancel"  ShowHeader="False" Visible="false">
    <ItemTemplate>
    <asp:LinkButton ID="lnkbtnCancel" runat="server" CausesValidation="False" CommandName="Cancel"><i class="far fa-window-close"></i></i></asp:LinkButton>
    </ItemTemplate>
    </asp:TemplateField>
    ...
    <asp:GridView  ID="gvAntwoord" runat="server" AutoGenerateColumns="False"  CssClass="table table-condensed table-hover" Width="100%" OnRowDeleting="OnRowDeleteAntwoord" DataKeyNames="answer_id" OnRowUpdating="OnRowUpdatingAntwoord" OnRowEditing="OnRowEditingAntwoord" OnRowCancelingEdit="OnRowCancelingEditAntwoord" AutoGenerateDeleteButton="False" AutoGenerateEditButton="False">
    <Columns>
    ...
    <asp:TemplateField AccessibleHeaderText="Update"  ShowHeader="False" Visible="false">
    <ItemTemplate>
    <asp:LinkButton ID="lnkbtnUpdate"   runat="server" CausesValidation="False" CommandName="Update"><i class="far fa-check-circle" style="color:#63c76f;"></i></asp:LinkButton>
    </ItemTemplate>
    </asp:TemplateField>

    <asp:TemplateField AccessibleHeaderText="Cancel"  ShowHeader="False" Visible="false">
    <ItemTemplate>
    <asp:LinkButton ID="lnkbtnCancel" runat="server" CausesValidation="False" CommandName="Cancel"><i class="far fa-window-close" style="color:#cf4236"></i></i></asp:LinkButton>
    </ItemTemplate>
    </asp:TemplateField>
    ...
    <asp:GridView onselectedindexchanged="gvVraagLeerling_SelectedIndexChanged" ID="gvVraagLeerling" runat="server" CssClass="table table-condensed table-hover" Width="100%" AutoGenerateColumns="False" DataKeyNames="ticket_id" AllowPaging="true" PageSize="5" onpageindexchanging="gvVraagLeerling_PageIndexChanging">
    <Columns>
    ...
    <asp:GridView  ID="gvAntwoordLeerling" runat="server" AutoGenerateColumns="False"  CssClass="table table-condensed table-hover" Width="100%" DataKeyNames="answer_id">
    <Columns>
    ...
    <div runat="server" id="divaddanswerleerling" visible="false" class="position-absolute mid-right">
    <a ID="btnAddAnswerLeerling" class="btn btn-primary" data-toggle="modal" data-target="#insertModalAnswer" style="cursor: pointer;color:#fff;"><strong>Reply </strong><i class="fas fa-reply"></i></a>
    </div>
    </div>
    </div>
    ...
    <h5 class="modal-title" id="fdf">Ready to Leave?</h5>
